...
if st.button("Submit"):
    if user_input:
        ...
        #     referral_link = referral_links[0]    # Get the links of the top suggestion
        # else:
        #     suggested_file = None
        #     referral_link = None
        # st.write(f"File: {suggested_file}")
...
# resources = load_resources()
# st.write(f"Loaded resources: {list(resources.keys())}")
...
#                     st.write(file)
#             else:
#                 st.write("No suggested files found.")
...
#                     st.write(link)
#             else:
#                 st.write("No referral links found.")
#         except Exception as e:
